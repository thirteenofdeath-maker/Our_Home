    ...
    <div className="finance-scope -mx-4 -mt-2 flex min-w-0 flex-col gap-5 px-4 pb-8 pt-3">
      ...
      {canEdit ? (
        <FormSheetButton
          ...
          triggerClassName="fixed bottom-[calc(env(safe-area-inset-bottom)+5.5rem)] right-[max(1.25rem,env(safe-area-inset-right))] z-20 flex size-14 items-center justify-center rounded-full bg-finance-primary text-finance-primary-foreground shadow-[0_8px_24px_rgb(79_112_88_/_0.3)] transition-transform active:scale-95"
