...
export default async function EditBillPage({
  ...
  const [wallets, pc, hc, pt, ht] = await Promise.all([
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-xl font-semibold">แก้ไขบิล</h1>
      <BillForm
        bill={bill}
        wallets={wallets}
