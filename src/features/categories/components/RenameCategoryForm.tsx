...
export function RenameCategoryForm({ id, currentName }: { id: string; currentName: string }) {
  const [editing, setEditing] = useState(false);
  const [state, formAction] = useActionState(renameCategoryAction, initialActionState);
