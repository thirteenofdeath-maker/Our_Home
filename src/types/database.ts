...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      get_credit_card_statements:{Args:{p_card_account_id:string};Returns:{statement_id:string;period_start:string;period_end:string;due_date:string;statement_balance:string|number;minimum_amount_due:string|number;paid_to_date:string|number;credits_to_date:string|number;effective_amount_due:string|number;status:string;minimum_payment_met:boolean}[]};
