...
export interface Database {
  public: {
    Tables: {
      ...
      credit_card_statements:{Row:{id:string;card_account_id:string;period_start:string;period_end:string;due_date:string;statement_balance:string|number;minimum_amount_due:string|number;created_by:string;created_at:string};Insert:never;Update:never;Relationships:[{foreignKeyName:"credit_card_statements_card_account_id_fkey";columns:["card_account_id"];isOneToOne:false;referencedRelation:"credit_card_accounts";referencedColumns:["id"]}]};
      credit_card_statement_allocations:{Row:{id:string;statement_id:string;liability_event_id:string;allocation_kind:"PAYMENT"|"CREDIT";amount:string|number;created_at:string};Insert:never;Update:never;Relationships:[{foreignKeyName:"credit_card_statement_allocations_statement_id_fkey";columns:["statement_id"];isOneToOne:false;referencedRelation:"credit_card_statements";referencedColumns:["id"]},{foreignKeyName:"credit_card_statement_allocations_liability_event_id_fkey";columns:["liability_event_id"];isOneToOne:false;referencedRelation:"credit_card_liability_events";referencedColumns:["id"]}]};
      pockets: {
        Row: {
          id: string;
          wallet_id: string;
      ...
      credit_card_installment_plans:{Row:{id:string;card_account_id:string;purchase_transaction_id:string;name:string;total_amount:string|number;installment_count:number;first_due_date:string;interval_months:number;created_by:string;archived_at:string|null;created_at:string};Insert:never;Update:never;Relationships:[{foreignKeyName:"credit_card_installment_plans_card_account_id_fkey";columns:["card_account_id"];isOneToOne:false;referencedRelation:"credit_card_accounts";referencedColumns:["id"]},{foreignKeyName:"credit_card_installment_plans_purchase_transaction_id_fkey";columns:["purchase_transaction_id"];isOneToOne:true;referencedRelation:"transactions";referencedColumns:["id"]}]};
      credit_card_installment_occurrences:{Row:{id:string;plan_id:string;sequence_number:number;due_date:string;expected_amount:string|number;payment_transaction_id:string|null;paid_at:string|null;created_at:string};Insert:never;Update:never;Relationships:[{foreignKeyName:"credit_card_installment_occurrences_plan_id_fkey";columns:["plan_id"];isOneToOne:false;referencedRelation:"credit_card_installment_plans";referencedColumns:["id"]},{foreignKeyName:"credit_card_installment_occurrences_payment_transaction_id_fkey";columns:["payment_transaction_id"];isOneToOne:true;referencedRelation:"transactions";referencedColumns:["id"]}]};
      credit_card_statement_resolutions:{Row:{statement_id:string;reason:string;resolved_by:string;resolved_at:string};Insert:never;Update:never;Relationships:[{foreignKeyName:"credit_card_statement_resolutions_statement_id_fkey";columns:["statement_id"];isOneToOne:true;referencedRelation:"credit_card_statements";referencedColumns:["id"]}]};
    ...
    Functions: {
      ...
      create_credit_card_installment_plan:{Args:{p_card_account_id:string;p_purchase_transaction_id:string;p_name:string;p_installment_count:number;p_first_due_date:string;p_interval_months?:number};Returns:string};
      pay_credit_card_installment_occurrence:{Args:{p_occurrence_id:string;p_from_wallet_id:string;p_from_pocket_id:string;p_title?:string|null;p_note?:string|null;p_occurred_at?:string|null};Returns:string};
      set_credit_card_installment_archived:{Args:{p_plan_id:string;p_archived:boolean};Returns:string};
      get_credit_card_installment_plans:{Args:Record<string,never>;Returns:{plan_id:string;card_account_id:string;card_name:string;currency:string;purchase_transaction_id:string;name:string;total_amount:string|number;installment_count:number;first_due_date:string;interval_months:number;paid_count:number;next_due_date:string|null;next_due_amount:string|number|null;archived_at:string|null}[]};
      get_credit_card_installment_occurrences:{Args:{p_plan_id:string};Returns:{occurrence_id:string;sequence_number:number;due_date:string;expected_amount:string|number;status:string;payment_transaction_id:string|null;paid_at:string|null}[]};
      get_credit_card_installment_candidates:{Args:{p_card_account_id:string};Returns:{transaction_id:string;title:string|null;occurred_at:string;amount:string|number}[]};
      ...
      issue_credit_card_statement:{Args:{p_card_account_id:string;p_period_start:string;p_period_end:string;p_due_date:string;p_minimum_amount_due?:string};Returns:string};
      get_credit_card_statements:{Args:{p_card_account_id:string};Returns:{statement_id:string;period_start:string;period_end:string;due_date:string;statement_balance:string|number;minimum_amount_due:string|number;paid_to_date:string|number;credits_to_date:string|number;effective_amount_due:string|number;status:string;minimum_payment_met:boolean;resolution_reason:string|null;resolved_at:string|null}[]};
      resolve_credit_card_statement:{Args:{p_statement_id:string;p_reason:string};Returns:string};
      get_credit_card_due_items:{Args:{p_today:string};Returns:{source:string;source_id:string;card_account_id:string;plan_id:string|null;title:string;due_date:string;amount:string|number;currency:string;scope:MoneyScope;status:string}[]};
